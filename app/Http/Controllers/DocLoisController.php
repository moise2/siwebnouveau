...
class DocLoisController extends Controller
{
    ...
    public function index()
    {
        ...
        $autoSelectedCategories = Category::where('name', 'Décrets et lois/arrêtés')->pluck('id')->toArray();

        // Compter le nombre de catégories auto-sélectionnées
        $autoSelectedCount = count($autoSelectedCategories);
        $searchRoute = route('documents.search.lois');
