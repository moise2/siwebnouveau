...
return [
    ...
    | qui sont données par le gestionnaire de mot de passe pour une tentative de mise à jour de mot de passe
    | a échoué, comme pour un jeton invalide ou un nouveau mot de passe invalide.
    |
    */
