...
@section('page-content')
    ...
    <div class="dropdown-container mt-4">
        <div class="dropdown">
            ...
            __('Années') <span id="annee-badge" class="badge bg-danger ms-2"></span>
            </button>
    ...
    <div class="table-container mt-4">
        ...
        <div class="mt-4">
            {{ $articleConseilministres->links('vendor.pagination.bootstrap-4') }}
        </div>
        <p>{{ $articleConseilministres->count() }} articles affichés sur cette page.</p>
        <p>Total des articles : {{ $articleConseilministres->total() }}</p>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchArticles() {
        ...
        fetch('/search-articles-conseil-ministre', {
            method: 'POST',
            headers: {
    ...
    function resetArticles() {
        ...
        fetch('/all-articles-conseil-ministre')
            .then(response => response.json())
            .then(data => {
                resultsContainer.innerHTML = data.map(article => `
                    <div class="col-12 col-md-4 mb-4 article-card" data-category="${article.category}">
