...
@section('page-content')
    ...
    <div class="table-container mt-4">
        ...
        <div class="mt-4">
            {{ $articlereformes->links('vendor.pagination.bootstrap-4') }}
        </div>
        <p>{{ $articlereformes->count() }} articles affichés sur cette page.</p>
        <p>Total des articles : {{ $articlereformes->total() }}</p>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function resetArticles() {
                ...
                fetch('/allArticlereformes') // Assurez-vous que cette route existe pour renvoyer tous les articles
                    .then(response => response.json())
                    .then(data => {
                        resultsContainer.innerHTML = data.map(article => `
                            <div class="col-12 col-md-4 mb-4 article-card" data-category="${article.category}">
