@extends('frontend.layouts.page', [
    'pageTitle' => 'Budget Dépense',
    'pageId' => 'documents'
])

@section('page-content')
    <h2 class="card-title">Budget dépense</h2>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function populateDropdowns() {
                const categories = ["Rapport", "Guide", "Document technique"]; // Modifiez ces catégories selon votre besoin
            ...
            function fetchDocuments() {
                ...
                .then(data => {
                    updateProgress(100);
                    if (data.data.length) { // Assurez-vous que cela correspond à votre structure de réponse
                        resultsContainer.innerHTML = data.data.map(document =>
                            `<div class="col-12 col-md-4 col-lg-3 mb-4 document-card" data-category="${document.category}">
                                <div class="card h-100">
                                    <div class="card-body d-flex flex-column">
